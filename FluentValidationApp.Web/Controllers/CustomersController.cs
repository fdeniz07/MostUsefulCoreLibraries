...
namespace FluentValidationApp.Web.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            var result = _customerValidator.Validate(customer); //Bu sayede her bir Validatoru buraya yazmak yerine ilgili tablonun iliskili dogrulamalarini tek kod ile burada cagirmis oluyoruz. Aksi durumda asagidaki su kodu yazmamiz gerekecekti:
